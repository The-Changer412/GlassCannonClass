...
namespace GlassCannonClass.Items.Armor.Pre_Boss
{
    ...
    internal class Gold_Glass_Helmet : ModItem
    {
        ...
        {
            return body.type == ModContent.ItemType<Gold_Glass_Chestplate>() && legs.type == ModContent.ItemType<Gold_Glass_Leggings>();
        }

        //apply the set bonus
        public override void UpdateArmorSet(Player player)
        {
            player.setBonus = Language.GetTextValue("Mods.GlassCannonClass.SetBonus.Gold_Glass");
